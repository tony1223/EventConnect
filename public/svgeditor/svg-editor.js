	...
	if(!window.svgEditor) window.svgEditor = function($) {
		...
		var defaultPrefs = {
			...
			curConfig = {
				...
				initOpacity: 1,
				imgPath: '/svgeditor/images/',
				langPath: '/svgeditor/locale/',
				extPath: '/svgeditor/extensions/',
				jGraduatePath: '/svgeditor/jgraduate/images/',
...
// 			});
		...
		//	var revnums = "svg-editor.js ($Rev: 2085 $) ";
